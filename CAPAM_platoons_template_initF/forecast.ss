#V3.30.14.00-safe;_2019_07_16;_Stock_Synthesis_by_Richard_Methot_(NOAA)_using_ADMB_12.0
...
1.0 # Buffer:  enter Control rule target as fraction of Flimit (e.g. 0.75), negative value invokes list of [year, scalar] with filling from year to YrMax 
