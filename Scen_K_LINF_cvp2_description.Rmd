...
Change 0.3 as the upper bound for CV old to 0.5.

Check out bounds of other runs (maybe using ss3sim summary fxns?) To see if
any other bounds need to be changed
